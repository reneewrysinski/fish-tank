...
const uint8_t* const FISH_SLEEP_FRAMES[] = {
...
const uint8_t* const FISH_SLEEPING_FRAMES[] = {
    FISH_SLEEP_19, FISH_SLEEP_20, FISH_SLEEP_21, FISH_SLEEP_22
};

const uint8_t* const FISH_SWIM_FRAMES[] = {
...
const uint8_t* const FISH_FEED_FRAMES[] = {
...
const uint8_t* const FISH_GAME_FRAMES[] = {
...
const uint8_t* const GAME_INTRO[] = {
    FISH_GAME_0, FISH_GAME_1
};

const uint8_t* const GAME_HIDE_Y[] = {
    FISH_GAME_2
};

const uint8_t* const GAME_HIDE_P[] = {
    FISH_GAME_3
};

const uint8_t* const GAME_HIDE_G[] = {
    FISH_GAME_4
};

const uint8_t* const GAME_HIDE_R[] = {
    FISH_GAME_5
};

const uint8_t* const GAME_WAVE[] = {
    FISH_GAME_6, FISH_GAME_7, FISH_GAME_8
};

const uint8_t* const GAME_P_WIN[] = {
    FISH_GAME_10, FISH_GAME_11, FISH_GAME_12
};

const uint8_t* const GAME_G_WIN[] = {
    FISH_GAME_13, FISH_GAME_14, FISH_GAME_15
};

const uint8_t* const GAME_R_WIN[] = {
    FISH_GAME_8, FISH_GAME_16, FISH_GAME_17
};

const uint8_t* const GAME_Y_WIN[] = {
    FISH_GAME_8, FISH_GAME_18, FISH_GAME_19
};

const uint8_t* const GAME_WIN[] = {
    FISH_GAME_20
};

const uint8_t* const GAME_LOSE[] = {
